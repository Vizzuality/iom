module OrganizationsHelper
  ...
  def funding_percentages(organization)
    private_percentage = ((organization.private_funding_spent / organization.budget)*100).to_i rescue 0
    usg_percentage = ((organization.usg_funding_spent / organization.budget)*100).to_i rescue 0
